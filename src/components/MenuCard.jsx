...
function MenuCard({ data }) {
    ...
    return (
        <div className='bg-white shadow-lg rounded-lg m-4 md:m-6'>
            <div className='relative rounded-lg overflow-hidden group'>
                <div className='group-hover:scale-105  absolute object-cover h-[20vh] w-full rounded-lg bg-black opacity-30'></div>
                <img src={data.image} className=' duration-700 transition group-hover:scale-105 object-cover h-[20vh] w-full rounded-lg' />
                                            ...
                                            item.allergens.map((allergen) => {
                                                return (
                                                    <div className='relative group' ref={tooltip}>
                                                        ...
                                                        <img className='h-6 w-6 cursor-pointer' src={allergen.image} />
                                                    </div>
                                                )
                                            })
